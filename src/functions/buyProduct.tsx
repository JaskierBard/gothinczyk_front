...
export const sellProduct = async (productPrice:number, merchantGold:number, itemId:string, type:string) => {
  // jeśli produkt jest drogi to zaptanie czy na pewno kupić
  // jeśli prokukt to strzały, potki to wyskakuje okienko z ilością do zakupienia?
  if (productPrice<merchantGold) {
      ...
      const audio = new Audio(process.env.PUBLIC_URL + '/audio/Npc/NO_MONEY_2.WAV')
      audio.play()
  }
}  